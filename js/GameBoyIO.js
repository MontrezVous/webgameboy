...
function initNewCanvas() {
	if (GameBoyEmulatorInitialized()) {
		...
		gameboy.canvas.width = 358;
		gameboy.canvas.height = 246;
		gameboy.canvas.rotate = 90;
		//document.getElementById('screen_cover').style.height = window.screen.height*(358/246);
		//document.getElementById("screen_cover").style.height = (window.screen.height*(358/246))/2+"px";
		//gameboy.canvas.width = (window.screen.width)/3;
		//gameboy.canvas.height = (window.screen.width*(246/358))/3;
	}
}
